...
async function cargarVistaPreviaReporte() {
    ...
    try {
        ...
        document.getElementById('statDiasCampana').textContent = `${diasCampana} Días de Campaña`;
        document.getElementById('statTotalAsistentes').textContent = `${asistentes.length} Total Asistentes`;
        ...
        const promedio = diasCampana > 0 && asistentes.length > 0 
            ...
            : 0;
        document.getElementById('statPromedioAsistencia').textContent = `${promedio}% Promedio Asistencia`;
...
function limpiarVistaReporte() {
    ...
    document.getElementById('statTotalAsistentes').textContent = '0 Total Asistentes';
    document.getElementById('statDiasCampana').textContent = '0 Días de Campaña';
    document.getElementById('statPromedioAsistencia').textContent = '0% Promedio Asistencia';
